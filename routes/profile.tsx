    ...
    return(<>
        ...
        <main className="bg-gray-50 min-h-screen text-gray-800">
            ...
            <section className="bg-gray-100 py-16 text-center">
                ...
                <a href={`https://wa.me/${messages.contact_person.text2}`} className="px-6 py-3 bg-blue-600 text-white rounded-lg shadow hover:bg-blue-700 transition">{messages.daftar_button}</a>
            </section>
        </main>
